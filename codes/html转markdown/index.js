...
function html2md (htmlData) {
    ...
    if (!isPrimitiveString(pureHtml) && "innerHTML" in pureHtml) {
        pureHtml = pureHtml.innerHTML
    }
...
// var html = document.querySelector(".container-fluid .col-md-9.col-sm-12>.p-3");
// var md = html2md(html)
// console.log(md)
// copyToClipboard(md)
...
document.addEventListener('mouseup', function () {
    ...
    if (result) {
        console.log('纯文本内容:', result.text);
        console.log('富文本内容:', result.html);
        console.log('Markdown内容:', result.markdown);

        copyToClipboard(result.markdown); // 复制Markdown内容到剪贴板
